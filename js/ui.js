...
export function describeError(err) {
  ...
  const known = {
    ...
    CANNOT_PAY_YOURSELF: 'This is your own listing.',
    PAYMENT_NOT_ALLOWED: 'That payment could not be filed against this listing.',
    NOT_YOUR_PAYMENT: 'Only the seller can settle this payment.',
    NO_SELLER_VPA: 'This seller has not added a UPI ID, so pay them another way.',
